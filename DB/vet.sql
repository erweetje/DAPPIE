...
INSERT INTO `consultatie` (`id`, `gewicht`, `dierId`, `datum`, `notitie`) VALUES
	(1, 10, 6, '0000-00-00 00:00:00', 'Pretty little puggy');
...
-- Dumpen data van tabel vet.dier: ~0 rows (ongeveer)
...
-- Dumpen data van tabel vet.klant: ~0 rows (ongeveer)
